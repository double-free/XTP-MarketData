...
enum XTP_SIDE_TYPE
{
	XTP_SIDE_BUY = 1,	///<买（新股申购、ETF申购等）
	XTP_SIDE_SELL,		///<卖（逆回购）
	XTP_SIDE_BUY_OPEN,		///<买开（暂未支持）
	XTP_SIDE_SELL_OPEN,		///<卖开（暂未支持）
	XTP_SIDE_BUY_CLOSE,		///<买平（暂未支持）
	XTP_SIDE_SELL_CLOSE,	///<卖平（暂未支持）
	XTP_SIDE_PURCHASE,		///<申购（暂未支持）
	XTP_SIDE_REDEMPTION,	///<赎回（暂未支持）
	XTP_SIDE_SPLIT,			///<拆分（暂未支持）
	XTP_SIDE_MERGE,			///<合并（暂未支持）
...
enum XTP_BUSINESS_TYPE
{
	...
	XTP_BUSINESS_TYPE_STRUCTURED_FUND_PURCHASE_REDEMPTION,	   ///<分级基金申赎业务（暂未支持）
	XTP_BUSINESS_TYPE_STRUCTURED_FUND_SPLIT_MERGE,	   ///<分级基金拆分合并业务（暂未支持）
